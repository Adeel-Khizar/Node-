...
const ProjectCount = () => {
 ...
 <div  className="flex lg:max-w-[70%] bg-black flex-col   justify-center items-start gap-12  ">
       ...
       <h2 style={{
        lineHeight: "95%"
       }} className={` ${Rancher}  text-[26px] md:text-[5vw] text-white`}>Creative Agency designing immersive websites from concept to reality <span className="opacity-80"> {fastText} </span></h2>
       <div>
