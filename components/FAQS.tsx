...
const FAQS: React.FC = () => {
    ...
    return (
        <div className='h-auto relative z-[111] bg-black px-[6vw] py-[45px] lg:py-[80px] flex flex-col justify-center items-start'>
            ...
            <p className={`${SedaN} text-md md:text-xl text-white `} >Our FAQs section provides quick answers to common inquiries about our services, project timelines, support options, and more.</p>
